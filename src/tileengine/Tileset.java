...
public class Tileset {
    ...
    public static final TETile KEY = new TETile('ꄗ', Color.ORANGE, Color.black, "key", 13);
    public static final TETile ORB = new TETile('o', Color.CYAN, Color.black, "orb", 14);
    public static final TETile ZONE = new TETile('·', Color.green, Color.darkGray, "zone", 15);
    public static final TETile LIGHTSWITCH = new TETile('i', Color.lightGray, Color.black, "light_switch", 16);
    public static final TETile AVATARWITHKEY = new TETile('@', Color.ORANGE, Color.black, "avatar_with_key", 17);
    public static final TETile TELEPORTER = new TETile('█', Color.BLUE, Color.black, "teleporter", 18);
    public static final TETile COIN = new TETile('o', Color.ORANGE, Color.black, "coin", 19);
